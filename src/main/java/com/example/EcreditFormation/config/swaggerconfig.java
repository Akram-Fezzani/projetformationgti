package com.example.EcreditFormation.config;
...
public class swaggerconfig {
	    ...
	    public Docket api() {
			return new Docket(DocumentationType.SWAGGER_2)
					...
					.apis(RequestHandlerSelectors.basePackage("com.example.EcreditFormation")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "com.esprit.examen".
